...
function GoldStructuredData() {
  ...
  const webpageJsonLd = {
    "@context": "https://schema.org",
    "@type": "WebPage",
    name: "Gold Melt Value Calculator (by Karat & Weight) | MarketMint",
    description:
      "Calculate gold melt value by karat and weight using today’s spot price. Estimate how much your gold is worth and compare buyer quotes to avoid lowball offers.",
    url: "https://marketmintapp.com/gold",
    isPartOf: {
      "@type": "WebSite",
      name: "MarketMint",
      url: "https://marketmintapp.com",
    },
  };
...
export default function GoldCalculatorPage() {
  ...
  return (
    <>
      {/* SEO HEAD (works in a client page without changing layout/logic) */}
      <Head>
        <title>Gold Melt Value Calculator (by Karat &amp; Weight) | MarketMint</title>
        <meta
          name="description"
          content="Calculate gold melt value by karat and weight using today’s spot price. Estimate how much your gold is worth and compare buyer quotes to avoid lowball offers."
        />
        <link rel="canonical" href="https://marketmintapp.com/gold" />

        <meta name="robots" content="index,follow,max-image-preview:large" />

        {/* Open Graph */}
        <meta property="og:type" content="website" />
        <meta property="og:site_name" content="MarketMint" />
        <meta property="og:title" content="Gold Melt Value Calculator (by Karat & Weight) | MarketMint" />
        <meta
          property="og:description"
          content="Instantly estimate how much your gold is worth using today’s spot price. Compare offers and avoid lowball quotes."
        />
        <meta property="og:url" content="https://marketmintapp.com/gold" />

        {/* Twitter */}
        <meta name="twitter:card" content="summary_large_image" />
        <meta name="twitter:title" content="Gold Melt Value Calculator (by Karat & Weight) | MarketMint" />
        <meta
          name="twitter:description"
          content="Calculate gold melt value by karat and weight using today’s spot price. Use it to compare buyer offers."
        />
      </Head>
      ...
      {/* LOADING STATE (layout unchanged) */}
      {!authChecked ? (
          ...
          <div className="mx-auto max-w-4xl px-4 py-10 space-y-10">
            ...
            <header className="space-y-4">
              ...
              <p className="text-base text-slate-300 max-w-3xl leading-relaxed">
                Enter gold karat and weight to estimate gold melt value using today’s spot price.
                Use this baseline to compare buyer quotes and avoid lowball offers.
              </p>
            ...
            <section className="rounded-2xl border border-slate-800 bg-slate-900/60 p-6 space-y-3">
              <GoldCalculator showSaveControls onSave={handleSave} lockMode="pdf" />
            ...
            <section className="space-y-4">
              ...
              >
                <ul className="space-y-1.5 text-[13px]">
                  ...
                  <li>• Useful for emergency cash, but rarely the best long-term price.</li>
                </ul>
              </AnimatedDisclosure>

              <AnimatedDisclosure title="Local jewelers" subtitle="Better than pawn, still conservative">
                <ul className="space-y-1.5 text-[13px]">
                  <li>• Commonly 10–30% higher than pawn shop offers.</li>
                  <li>• Good balance of speed, trust, and payout — especially if you shop 2–3 stores.</li>
                </ul>
              </AnimatedDisclosure>
