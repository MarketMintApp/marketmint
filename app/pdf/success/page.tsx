    ...
    <main className="min-h-[80vh] bg-slate-950 text-slate-50">
      <div className="mx-auto max-w-5xl px-4 pb-16 pt-10">
        <div className="mx-auto max-w-2xl">
          <div className="mb-4 h-6 w-40 rounded-full bg-slate-800/60" />
          ...
          <div className="mt-8 rounded-2xl border border-slate-800 bg-slate-900/40 p-6">
            <div className="h-5 w-56 rounded bg-slate-800/60" />
            <div className="mt-3 h-4 w-3/4 rounded bg-slate-800/60" />
            <div className="mt-6 h-12 w-full rounded-full bg-slate-800/60" />
            <div className="mt-3 h-12 w-full rounded-full bg-slate-800/60" />
          </div>
        </div>
      </div>
    </main>
